...
### 목표
- 코스 조회/생성/수정, 코스 좋아요, 코스 체크인까지 한 브랜치에서 구현한다.
...
- 체크인이 공식 코스에서만 허용되고, `15m` 반경에서만 성공한다.

### 다음 단계로 넘어가는 조건
- 앱의 코스 탭, 코스 좋아요, 체크인 흐름이 서버 응답 기준으로 동작 가능하다.
...
### 브랜치명
- `codex/07-courses`에서 흡수 완료

### 목표
- 공식 코스 체크인과 기본 안정화 항목을 `codex/07-courses`에서 함께 마무리한다.
